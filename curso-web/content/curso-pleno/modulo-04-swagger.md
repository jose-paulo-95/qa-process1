...
**Recursos:** Swagger ServeRest (https://serverest.dev/doc)
...
**Recursos:** Postman, Swagger ServeRest (https://serverest.dev/doc)
...
**Recursos:** Swagger ServeRest, Postman, API ServeRest (https://serverest.dev)
...
- Seu projeto tem Swagger/OpenAPI? Abra e compare com o comportamento real da API
- Importe a collection do Swagger do seu projeto no Postman (se existir)
- Em 1 endpoint real, adicione validação de contrato no script Tests

## Sugestão de pauta para mentoria

- "Como validamos contrato de API no nosso projeto?"
- "Existem inconsistências entre documentação e implementação?"
- "Posso mostrar minhas validações no Postman para feedback?"

## Checklist de aplicação

- [ ] Fiz todos os exercícios
- [ ] Validei contrato em pelo menos 1 endpoint do meu projeto
