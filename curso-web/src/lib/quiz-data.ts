...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    question: "Você quer comparar dois valores e garantir que sejam **iguais e do mesmo tipo**, sem conversão automática (ex.: número 5 não deve ser considerado igual ao texto '5'). O que usar?",
    options: [
      { id: "a", text: "Igualdade que permite conversão de tipo antes de comparar", correct: false, feedbackWrong: "Essa forma pode dar 'igual' mesmo com tipos diferentes e esconder erro de lógica." },
      { id: "b", text: "Igualdade estrita (mesmo valor e mesmo tipo)", correct: true, feedbackCorrect: "Correto! Só aceita igualdade quando valor e tipo batem — o que você quer nessa regra." },
      { id: "c", text: "Apenas 'maior que' e 'menor que'", correct: false, feedbackWrong: "Comparações de ordem não respondem se dois valores são iguais." },
      { id: "d", text: "Apenas 'E' e 'OU' entre condições", correct: false, feedbackWrong: "São operadores lógicos; não substituem a comparação de igualdade." },
    ],
  },
  {
    id: "q-oplog-2",
    temaSlug: "operadores-logicos",
    question: "A afirmação lógica 'cinco é maior **ou igual** a cinco' é:",
    options: [
      { id: "a", text: "Falsa, porque cinco não é maior que cinco", correct: false, feedbackWrong: "'Maior ou igual' inclui o caso em que os dois números são iguais — então a afirmação é verdadeira." },
      { id: "b", text: "Verdadeira", correct: true, feedbackCorrect: "Correto! O 'ou igual' faz o limite entrar na condição — útil em regras com mínimo e máximo." },
      { id: "c", text: "Inválida (não se pode comparar um número com ele mesmo)", correct: false, feedbackWrong: "Pode comparar; o resultado é verdadeiro ou falso." },
      { id: "d", text: "Indefinida até escolher a linguagem de programação", correct: false, feedbackWrong: "Em lógica comum, a relação 'maior ou igual' já tem significado claro." },
    ],
  },
  {
    id: "q-oplog-3",
    temaSlug: "operadores-logicos",
    question: "O resultado de **verdadeiro E falso** (conjunção) é:",
    options: [
      { id: "a", text: "Verdadeiro", correct: false, feedbackWrong: "O **E** só é verdadeiro quando **ambas** as partes são verdadeiras." },
      { id: "b", text: "Falso", correct: true, feedbackCorrect: "Correto! Com uma parte falsa, a conjunção inteira é falsa." },
      { id: "c", text: "Depende da ordem em que as partes foram escritas", correct: false, feedbackWrong: "Para valores já verdadeiro/falso, a ordem não muda o resultado do E." },
      { id: "d", text: "Nem verdadeiro nem falso", correct: false, feedbackWrong: "O resultado de uma conjunção de duas condições booleanas é verdadeiro ou falso." },
    ],
  },
  {
    id: "q-oplog-4",
    temaSlug: "operadores-logicos",
    question: "O resultado de **falso OU verdadeiro** (disjunção inclusiva) é:",
    options: [
      { id: "a", text: "Falso", correct: false, feedbackWrong: "O **OU** inclusivo é verdadeiro se **pelo menos uma** parte for verdadeira." },
      { id: "b", text: "Verdadeiro", correct: true, feedbackCorrect: "Correto! Basta uma parte verdadeira." },
      { id: "c", text: "Só é verdadeiro se as duas partes forem verdadeiras", correct: false, feedbackWrong: "Isso descreveria o **E**, não o OU." },
      { id: "d", text: "Depende de haver parênteses na expressão", correct: false, feedbackWrong: "Entre apenas 'falso' e 'verdadeiro', o resultado já fica definido." },
    ],
  },
  {
    id: "q-oplog-5",
    temaSlug: "operadores-logicos",
    question: "Considere: primeiro avalia-se se **cinco é igual a cinco** (no sentido estrito: mesmo valor e mesmo tipo); depois aplica-se a **negação** desse resultado. O resultado final é:",
    options: [
      { id: "a", text: "Verdadeiro", correct: false, feedbackWrong: "A igualdade estrita entre cinco e cinco é verdadeira; negar isso dá falso." },
      { id: "b", text: "Falso", correct: true, feedbackCorrect: "Correto! Nega-se um fato verdadeiro, logo o resultado é falso." },
      { id: "c", text: "Não se pode negar uma igualdade", correct: false, feedbackWrong: "Pode-se negar qualquer condição booleana." },
      { id: "d", text: "O mesmo que 'cinco é igual a cinco' sem negação", correct: false, feedbackWrong: "A negação inverte o valor lógico; não fica igual." },
    ],
  },
  {
    id: "q-oplog-6",
    temaSlug: "operadores-logicos",
    question: "A condição 'idade está entre 18 e 65 anos, **incluindo** 18 e 65' costuma ser escrita como duas comparações ligadas por **E**. Qual par está correto?",
    options: [
      { id: "a", text: "idade maior que 18 **e** idade menor que 65", correct: false, feedbackWrong: "Isso **exclui** quem tem exatamente 18 ou 65 anos." },
      { id: "b", text: "idade maior ou igual a 18 **e** idade menor ou igual a 65", correct: true, feedbackCorrect: "Correto! Os dois limites entram no intervalo fechado." },
      { id: "c", text: "idade igual a 18 **ou** idade igual a 65", correct: false, feedbackWrong: "Isso só seria verdade para exatamente 18 ou 65, não para todo o intervalo." },
      { id: "d", text: "idade maior ou igual a 18 **ou** idade menor ou igual a 65", correct: false, feedbackWrong: "Com **OU** assim, quase qualquer idade tornaria a condição verdadeira (ex.: 10 anos satisfaz 'menor ou igual a 65')." },
    ],
  },
  {
    id: "q-oplog-7",
    temaSlug: "operadores-logicos",
    question: "Em muitas linguagens, na expressão **A E B**, se **A** já for falso:",
    options: [
      { id: "a", text: "**B** pode nem ser avaliado (curto-circuito)", correct: true, feedbackCorrect: "Correto! O resultado do **E** já é falso; muitas linguagens não avaliam **B**." },
      { id: "b", text: "**B** sempre é avaliado, mesmo com **A** falso", correct: false, feedbackWrong: "Com **A** falso, o **E** já falhou; em várias linguagens **B** não é avaliado." },
      { id: "c", text: "Só acontece quando **A** e **B** são números", correct: false, feedbackWrong: "Curto-circuito vale para expressões lógicas em geral, não só números." },
      { id: "d", text: "Isso é sempre um erro de sintaxe", correct: false, feedbackWrong: "É comportamento definido da linguagem, não erro." },
    ],
  },
  {
    id: "q-oplog-8",
    temaSlug: "operadores-logicos",
    question: "Você quer expressar corretamente: '**não** é verdade que a nota é igual a 10'. Qual formulação equivale a essa negação?",
    options: [
      { id: "a", text: "Negar só a palavra 'nota' e depois comparar com 10", correct: false, feedbackWrong: "A negação deve aplicar-se à **condição inteira** 'nota é igual a 10', não a um pedaço solto." },
      { id: "b", text: "A nota é **diferente** de 10", correct: true, feedbackCorrect: "Correto! 'Não (nota igual a 10)' equivale a 'nota diferente de 10'." },
      { id: "c", text: "A nota é menor que 10", correct: false, feedbackWrong: "Isso exclui notas maiores que 10; a negação de 'igual a 10' inclui qualquer valor diferente de 10." },
      { id: "d", text: "A nota é maior que 10", correct: false, feedbackWrong: "Também não cobre o caso 'nota menor que 10'; a negação de 'igual a 10' é 'diferente de 10'." },
    ],
  },
];
