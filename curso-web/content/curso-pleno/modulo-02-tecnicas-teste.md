...
**Recursos:** Documentação de requisitos ou formulário real
...
- Na próxima story, escolha 1 técnica e aplique (ex: "vou usar valor limite no campo quantidade")
- Liste 2 endpoints do seu projeto e identifique as classes de equivalência para cada um
- Em um caso de teste existente, inclua 1 cenário negativo que ainda não está coberto

## Sugestão de pauta para mentoria

- "Como você usa particionamento de equivalência no dia a dia?"
- "Pode dar um exemplo de edge case que encontrou em um fluxo real?"
- "Quais técnicas você prioriza quando o tempo é curto?"

## Checklist de aplicação

- [ ] Fiz todos os exercícios
- [ ] Apliquei pelo menos 1 técnica em uma story
