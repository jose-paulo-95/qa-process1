# Módulo 3: Testes de API (Postman)

**Objetivo:** Ao final deste módulo, o aluno será capaz de criar requests (GET, POST, PUT, DELETE, PATCH), organizar collections, usar variáveis (locais, ambiente, globais), escrever scripts Pre/Test e executar via Newman.
