  ...
  7: [
    {
      id: "p7-q1",
      temaSlug: "prova-7",
      question: "Por que, na lógica de programação, costuma-se preferir **igualdade estrita** (mesmo valor **e** mesmo tipo) em vez de uma igualdade que **converte** tipos automaticamente?",
      options: [
        { id: "a", text: "Porque a igualdade estrita é sempre mais rápida de calcular", correct: false, feedbackWrong: "O motivo principal é clareza e segurança da condição, não velocidade." },
        { id: "b", text: "Porque evita surpresas: número 5 e texto '5' não devem ser tratados como iguais quando a regra exige tipo definido", correct: true, feedbackCorrect: "Correto! A comparação fica alinhada ao que a regra realmente pede." },
        { id: "c", text: "Porque não existe igualdade com conversão em nenhuma linguagem", correct: false, feedbackWrong: "Várias linguagens permitem comparação com conversão; o ponto é saber o que você quer modelar." },
        { id: "d", text: "Porque igualdade estrita só funciona para letras, não para números", correct: false, feedbackWrong: "Igualdade estrita aplica-se a qualquer tipo, desde que valor e tipo coincidam." },
      ],
    },
    {
      id: "p7-q2",
      temaSlug: "prova-7",
      question: "O resultado lógico de **verdadeiro E falso** é:",
      options: [
        { id: "a", text: "Verdadeiro", correct: false, feedbackWrong: "O **E** exige as duas partes verdadeiras." },
        { id: "b", text: "Falso", correct: true, feedbackCorrect: "Correto! Uma parte falsa derruba a conjunção." },
        { id: "c", text: "Indefinido até escolher a linguagem", correct: false, feedbackWrong: "Em lógica booleana clássica, o resultado é falso." },
        { id: "d", text: "Depende da ordem das palavras na frase", correct: false, feedbackWrong: "Para valores já fixos em V/F, a ordem não muda o resultado do E." },
      ],
    },
    {
      id: "p7-q3",
      temaSlug: "prova-7",
      question: "Para 'idade entre 18 e 65 anos, **incluindo** 18 e 65', a combinação correta com **E** é:",
      options: [
        ...
        { id: "b", text: "idade maior ou igual a 18 **e** idade menor ou igual a 65", correct: true, feedbackCorrect: "Correto! Intervalo fechado nos dois limites." },
        { id: "c", text: "idade igual a 18 **ou** idade igual a 65", correct: false, feedbackWrong: "Só seria verdade nesses dois pontos, não em todo o intervalo." },
        { id: "d", text: "idade maior ou igual a 18 **ou** idade menor ou igual a 65", correct: false, feedbackWrong: "Com **OU** assim, quase qualquer idade satisfaz a segunda parte." },
      ],
    },
    {
      id: "p7-q4",
      temaSlug: "prova-7",
      question: "Em muitas linguagens, na expressão **A E B**, se **A** já for falso e houver **curto-circuito**:",
      options: [
        { id: "a", text: "**B** pode não ser avaliado", correct: true, feedbackCorrect: "Correto! O resultado do **E** já é falso." },
        { id: "b", text: "**B** sempre é avaliado", correct: false, feedbackWrong: "Com curto-circuito, em várias linguagens **B** nem roda quando **A** já falhou." },
        { id: "c", text: "O programa deve emitir erro de sintaxe", correct: false, feedbackWrong: "É comportamento permitido pela definição da linguagem." },
        { id: "d", text: "O resultado passa a ser 'nem verdadeiro nem falso'", correct: false, feedbackWrong: "O resultado do **E** com booleanos é verdadeiro ou falso." },
      ],
    },
    {
      id: "p7-q5",
      temaSlug: "prova-7",
      question: "A negação correta da condição '**a pontuação é igual a 100**' (no sentido: não é verdade que a pontuação é 100) equivale a:",
      options: [
        { id: "a", text: "A pontuação é menor que 100", correct: false, feedbackWrong: "Isso ignora pontuações maiores que 100." },
        { id: "b", text: "A pontuação é **diferente** de 100", correct: true, feedbackCorrect: "Correto! 'Não (igual a 100)' é o mesmo que 'diferente de 100'." },
        { id: "c", text: "A pontuação é maior que 100", correct: false, feedbackWrong: "Também não cobre valores abaixo de 100." },
        { id: "d", text: "Negar só a palavra 'pontuação' e manter 'igual a 100'", correct: false, feedbackWrong: "A negação deve valer para a condição inteira." },
      ],
    },
  ],
};
