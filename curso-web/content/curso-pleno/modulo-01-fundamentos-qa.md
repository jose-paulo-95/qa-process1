...
*Termos: ver [glossário QA](../../../docs/avaliacao/pdi/glossario-qa.md) (Smoke, Regressão, UAT, E2E, etc.)
...
**Recursos:** Sua experiência recente, [boas-praticas-qa.md](../../../docs/avaliacao/pdi/boas-praticas-qa.md)
...
**Enunciado:** Imagine que você encontrou um bug: o campo "Quantidade" aceita valor negativo e o sistema permite finalizar compra. Escreva o reporte completo seguindo as boas práticas de [boas-praticas-qa.md](../../../docs/avaliacao/pdi/boas-praticas-qa.md).
...
- Na próxima story, classifique em qual fase do ciclo você está (Design? Execução?)
- Use o template de bug do projeto ao reportar um defeito
- Compare: como sua equipe classifica severidade/prioridade? Está alinhado ao que aprendeu?

## Sugestão de pauta para mentoria

- "Como nosso processo mapeia nas 6 fases do ciclo de vida?"
- "Quais critérios usamos para severidade e prioridade?"
- "Posso mostrar um bug que reportei para feedback?"

## Checklist de aplicação

- [ ] Fiz todos os exercícios
- [ ] Apliquei pelo menos 1 conceito no meu projeto
